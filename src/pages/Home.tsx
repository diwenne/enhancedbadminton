        ...
        <div style={{ maxWidth: "var(--container-max)", margin: "0 auto" }}>
          ...
          <div className="info-grid">
            <div className="info-card" style={{
              ...
              <a href="/programs/2026-0506-junior.pdf" target="_blank" rel="noopener noreferrer" className="cta-button" style={{ marginTop: "auto" }}>
            ...
            <div className="info-card" style={{
              ...
              <a href="/programs/2026-0506-adult.pdf" target="_blank" rel="noopener noreferrer" className="cta-button" style={{ marginTop: "auto" }}>
                View Adult Programs →
              </a>
            </div>
